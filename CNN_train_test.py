...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('9025') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
